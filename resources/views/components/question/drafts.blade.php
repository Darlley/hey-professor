...
<div class="p-6 text-gray-900 dark:text-gray-100 rounded-lg bg-white">
    <div class="mb-2">
        ...
        <li class="flex flex-wrap items-center justify-between gap-x-6 gap-y-4 py-5 sm:flex-nowrap">
            ...
            <dl class="flex w-full flex-none justify-between gap-x-8 sm:w-auto">
                <div class="flex -space-x-0.5 flex-col w-full">
                    <dt class="flex gap-2 justify-between">
                        ...
                        <x-question.form :action="route('question.destroy', $question)" delete>
                            <button type="submit" class="text-red-700 hover:text-red-500 flex justify-center mt-4">
                                <!-- <x-icons.trash class="w-5 h-5" fill="none" /> -->
                                <span class="text-xs">Deletar</span>
                            </button>
                        </x-question.form>
                        
                        <x-question.form :action="route('question.publish', $question)" put>
                            <button type="submit" class="text-gray-700 hover:text-gray-500 flex justify-center mt-4">
                                <!-- <x-icons.publish class="w-5 h-5" fill="none" /> -->
